...
then
  echo "20009"
sudo /opt/IBM/InstallationManager/eclipse/tools/imcl install 20.0.0.9-WS-WLP-IFPH29942 -repositories /home/ibmdemo/app-mod-labs/d20200st/20.0.0.9-ws-wlp-ifph29942 -installationDirectory /home/ibmdemo/Liberty/Liberty20009 -log logfix_20009.log
else
  echo "others" "$1"
